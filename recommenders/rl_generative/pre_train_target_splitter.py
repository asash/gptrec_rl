...
class PreTrainTargetSplitter(TargetSplitter):
    ...
    def split(self, sequence):
        ...
        return [], sequence[:target_actions] #return first only first part, second part is not needed for an autoregressive model. 
