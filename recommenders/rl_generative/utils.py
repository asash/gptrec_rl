...
class TrialResult(object):
    def __init__(self, reward, seq, recs, recs_with_scores, gt_action) -> None:
        self.reward = reward
        self.seq = seq
        self.recs = recs
...
def build_trial_result(gt_action, recommendations, seq, items, reward_metric):
        recs_with_scores = [] 
        ...
        return TrialResult(reward=reward, seq=seq, recs=recommendations, recs_with_scores=recs_with_scores, gt_action=gt_action)