...
class SalrecRecommender(Recommender):
    ...
    def get_model(self, n_items):
        ...
        x = layers.Dense(256, name="bottleneck_after_dropout", activation='swish', kernel_regularizer='l2', bias_regularizer='l2')(x)
        output = layers.Dense(n_items, name="output", activation=self.output_layer_activation, kernel_regularizer='l2', bias_regularizer='l2')(x)
