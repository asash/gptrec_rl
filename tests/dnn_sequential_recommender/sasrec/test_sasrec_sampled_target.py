...
class TestSasrecSampledTarget(unittest.TestCase):
    def test_sasrec_model_sampled_target(self):
        ...
        from aprec.recommenders.sequential.target_builders.sampled_matrix_target_builder import SampledMatrixBuilder
        ...
        model = SASRecModelBuilder(embedding_size=32, sampled_targets=101)
