...
from aprec.recommenders.sequential.models.bert4recft.bert4recft import SampleBERTConfig
...
class TestFullBert(unittest.TestCase):
    def test_two_berts(self):
        ...
        embedding_size=32
        model_config =  SampleBERTConfig(embedding_size=embedding_size, loss='bce')
