...
recommenders_raw = {
    ...
    "CASER-Lambdarank-Vanilla": lambda: dnn("caser", "lambdarank"),
    "CASER-Lambdarank-Truncated:2500": lambda: dnn("caser", "lambdarank", loss_pred_truncate=2500),
    "CASER-Lambdarank-Truncated:2500-bce-weight:0.975": lambda: dnn("caser", "lambdarank", loss_pred_truncate=2500, loss_bce_weight=0.975),
}
